        ...
        return {
            ...
            list: async(table, conditions = null) => {
                ...
                try {
                    ...
                    let results = (Array.isArray(params) && params.length > 0) ? await dbContext.query(`${querytext};`, params) : await dbContext.query(`${querytext};`);
                    return results.rows;
                } catch(err) {
            ...
            paginate: async(table, paginateparams, conditions = null) => {
                ...
                try {
                    ...
                    let res =  await dbContext.query(`${querytext};`, params);
                    return res.rows;
                } catch(err) {
                  console.debug('QUERY TEXT', querytext);
                  throw err;
            ...
            findone: async(table, conditions = null) => {
                ...
                try {
                    ...
                    if (Array.isArray(params) && params !== null) params = params.filter(x=> (x !== null) && (x!== undefined));
                    let res = (Array.isArray(params) && params.length > 0) ? await dbContext.query(`${querytext} LIMIT 1;`, params) : await dbContext.query(`${querytext} LIMIT 1;`);
            ...
            findonerandom: async(table, conditions = null) => {
                ...
                try {
                    ...
                    if(Array.isArray(params) && params.length > 0) {
                        res =  await dbContext.query(`${querytext} ORDER BY random() LIMIT 1;`, params);
                    } else {
                        res = await dbContext.query(`${querytext} ORDER BY random() LIMIT 1;`);
                    }
                    return res.rows[0];
                } catch(err) {
                  console.debug('QUERY TEXT', querytext);
            ...
            */
            findall: async(table, conditions = null) => {
                ...
                try {
                    ...
                    if (Array.isArray(params) && params !== null) params = params.filter(x=> (x !== null) && (x!== undefined));
                    let res = (Array.isArray(params) && params.length > 0) ? await dbContext.query(`${querytext} LIMIT 1;`, params) : await dbContext.query(`${querytext} LIMIT 10;`);
            ...
            create: async(table, data1 = null, data2 = null, cb = null) => {
                ...
                if(data1 === null) {
                    ...
                    try {
                        let res = (cb) ? await cb.query(querytext, values) : await dbContext.query(querytext, values);
                        return res.rows[0];
                    } catch(err) {
                        console.debug('QUERY TEXT', querytext);
                        throw Error;
                ...
                try{
                    ...
                    let res = (cb) ? await cb.query(querytext, bindParams) : await dbContext.query(querytext, bindParams);
            ...
            one_to_many_create: async (table, columns, values) => {
                ...
                try {
                    let res = await dbContext.query(querytext, values);
            ...
            update: async(table, conditions, newValues) => {
                ...
                try{
                    ...
                    let res = await dbContext.query(`${querytext} RETURNING *;`, params);
                    return res.rows;
                } catch(err) {
                    console.debug('QUERY TEXT', querytext);
            ...
            customquery: async(text, params = null) => {
                ...
                return dbContext.query(text, params)
                .catch(e => {
